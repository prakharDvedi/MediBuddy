...
export const APP_COPY: Record<Locale, AppCopy> = {
  ...
  hi: {
    shell: { tagline: "समझें। सत्यापित करें। बचत करें।", login: "लॉग इन", signup: "साइन अप", logout: "लॉग आउट", backToDashboard: "डैशबोर्ड पर वापस जाएँ", newCheck: "नई जाँच", caseReview: "केस समीक्षा", language: "भाषा", renameCase: "नाम बदलने के लिए क्लिक करें", saveTitleError: "नाम सहेजा नहीं जा सका" },
    ...
    auth: { welcomeBack: "वापसी पर स्वागत है", login: "लॉग इन", loginDescription: "अपने सहेजे गए बिलों, पॉलिसी सारांशों और सवालों पर वापस जाएँ।", email: "ईमेल", password: "पासवर्ड", loggingIn: "लॉग इन किया जा रहा है...", noAccount: "खाता नहीं है?", signup: "साइन अप", calmerWay: "समीक्षा करने का आसान तरीका", signupDescription: "अपने अस्पताल के बिलों और बीमा सवालों के लिए निजी कार्यक्षेत्र बनाएँ।", signingUp: "साइन अप किया जा रहा है...", alreadyHaveAccount: "पहले से खाता है?", checkEmail: "अपना ईमेल देखें", confirmationDescription: "अगर यह पता ईमेल प्राप्त कर सकता है, तो {email} पर पुष्टि लिंक आएगा। अपना स्पैम फ़ोल्डर भी देखें। अगर आपका खाता पहले से है, तो लॉग इन करें।", requestingLink: "लिंक माँगा जा रहा है...", tryAgainIn: "{seconds} सेकंड में फिर कोशिश करें", resendConfirmation: "पुष्टि ईमेल फिर भेजें", loginInstead: "इसके बजाय लॉग इन करें", confirmationRequested: "अगर यह पता ईमेल प्राप्त कर सकता है, तो नया पुष्टि लिंक माँगा गया है।", authError: "प्रमाणीकरण त्रुटि", unspecifiedError: "एक अनिर्दिष्ट त्रुटि हुई।" },
