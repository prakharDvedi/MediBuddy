...
const HI_INTENTS: Record<CaseIntent, IntentCopy> = {
  bill: {
    ...
    title: "अस्पताल का bill या estimate जाँचें",
    cardDescription: "जाँचने योग्य charges और दवा की कीमतें देखें। जानें क्या पूछना है।",
    onboardingTitle: "अस्पताल का bill या estimate upload करें",
    onboardingDescription: "हम charges निकालेंगे, उपलब्ध reference prices से तुलना करेंगे और जाँचने योग्य बातें दिखाएँगे।",
    uploadGuidance: "अस्पताल का bill या estimate से शुरू करें। बाद में एक और document जोड़ सकते हैं।",
  },
  policy: {
    eyebrow: "पॉलिसी की स्पष्टता",
    title: "अपनी insurance policy समझें",
    cardDescription: "Coverage limits और exclusions देखें। आसान भाषा में सवाल पूछें।",
    onboardingTitle: "अपनी insurance policy upload करें",
    onboardingDescription: "हम coverage limits का सारांश बनाएँगे और covered चीज़ों के बारे में स्पष्ट सवाल पूछने में मदद करेंगे।",
    uploadGuidance: "अपनी insurance policy से शुरू करें। हम इसके coverage details निकालेंगे।",
  },
  compare: {
    eyebrow: "पहले से योजना",
    title: "जानें insurance कितना दे सकता है",
    cardDescription: "अनुमान लगाएँ कि insurance कितना देगा और आपको कितना देना पड़ सकता है।",
    onboardingTitle: "अस्पताल का bill या estimate से शुरू करें",
    onboardingDescription: "Insurance कितना दे सकता है और आपको कितना देना पड़ सकता है, इसका अनुमान लगाने के लिए policy भी जोड़ें।",
    uploadGuidance: "अस्पताल का bill या estimate से शुरू करें। अगली screen पर insurance policy जोड़ सकते हैं।",
  },
};
...
export const APP_COPY: Record<Locale, AppCopy> = {
  ...
  hi: {
    shell: { tagline: "समझें। Verify करें। बचत करें।", login: "लॉग इन", signup: "साइन अप", logout: "लॉग आउट", backToDashboard: "डैशबोर्ड पर वापस जाएँ", newCheck: "नई जाँच", caseReview: "केस समीक्षा", language: "भाषा", renameCase: "नाम बदलने के लिए क्लिक करें", saveTitleError: "नाम save नहीं हो सका" },
    home: { headline: "Bill समझें। अगला सवाल जानें।", description: "Reference-backed findings और आसान भाषा में explanations के साथ hospital bills और insurance policies की समीक्षा करें।", primaryAction: "Bill या policy जाँचें", disclaimer: "MedBud आपको बेहतर सवाल पूछने में मदद करता है। यह diagnosis नहीं करता, clinical care पर निर्णय नहीं देता और यह तय नहीं करता कि अस्पताल ने कानून तोड़ा है।", exampleReview: "उदाहरण समीक्षा", exampleTitle: "Surgery estimate", worthInvestigating: "जाँचने योग्य", totalEstimate: "कुल estimate", potentialDifference: "संभावित अंतर", medicinePrice: "दवा की कीमत", hospitalCharge: "अस्पताल का चार्ज", nppaReference: "NPPA reference", page: "पेज", referenceDisclaimer: "Reference price चर्चा के लिए evidence है, पैसे वापस मिलने की गारंटी नहीं।", startWithQuestion: "एक सवाल से शुरू करें", reviewDepends: "सही review इस बात पर निर्भर है कि आपको क्या जानना है।", originalDocuments: "MedBud आपके original documents को निकाली गई जानकारी से अलग रखता है और दिखाता है कि महत्वपूर्ण numbers कहाँ से आए।", referenceDisclaimerLong: "Reference prices hospital billing caps या वापस मिलने वाली guaranteed रकम नहीं हैं। हमेशा hospital, pharmacist या insurer से पुष्टि करें।", intents: HI_INTENTS },
    dashboard: { headline: "अपने healthcare costs समझें", description: "Bills की समीक्षा करें, medicine और procedure references जाँचें और समझें कि insurance क्या cover कर सकता है।", startNewCheck: "नई जाँच शुरू करें", chooseStartingPoint: "शुरुआत चुनें", startHere: "यहाँ से शुरू करें", guidedDemos: "Guided demos", seeInAction: "MedBud को काम करते देखें", demoDisclaimer: "ये controlled synthetic documents हैं, आपकी account के लिए private रूप से बनाए गए हैं। ये असली medical या insurance records नहीं हैं।", tryBill: "Sample hospital bill आज़माएँ", tryBillDescription: "Medicine references, CGHS comparison और cited source pages के साथ duplicate-charge checks देखें।", tryPolicy: "Sample insurance case आज़माएँ", tryPolicyDescription: "Policy retrieval, coverage findings, questions और estimate-versus-policy comparison देखें।", preparingDemo: "आपका demo तैयार हो रहा है...", creatingCase: "नई case बनाई जा रही है", createCase: "नई case बनाएँ →", demoError: "Demo case नहीं बन सकी", yourWork: "आपका काम", recentChecks: "हाल की जाँच", saved: "सहेजे गए", noChecks: "अभी कोई जाँच नहीं", noChecksDescription: "Hospital bill या insurance policy upload करके शुरू करें। आपका काम यहाँ दिखेगा।", workflowLabels: { "Bill + insurance policy": "Bill + insurance policy", "Insurance policy": "Insurance policy", "Hospital bill": "Hospital bill", "Hospital estimate": "Hospital estimate", "Procedure quote": "Procedure quote", Prescription: "Prescription", "Insurance approval": "Insurance approval", "Healthcare document": "Healthcare document", "No document yet": "अभी document नहीं" }, statusLabels: { attention: "ध्यान देने की ज़रूरत", processing: "Processing", findings: "{count} जाँचने योग्य बातें", finding: "{count} जाँचने योग्य बात", ready: "Review के लिए तैयार" }, actionLabels: { continue: "जारी रखें", view: "देखें" }, potentialDifference: "संभावित अंतर" },
